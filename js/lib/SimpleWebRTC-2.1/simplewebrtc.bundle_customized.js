...
SimpleWebRTC.prototype.joinRoom = function (roomName, pwd, cb) {
    var self = this;
    this.roomName = roomName;
    this.connection.emit('join', roomName, pwd, function (err, roomDescription) {
...
SimpleWebRTC.prototype.createRoom = function (roomName, adminPwd, roomPwd, cb) {
    this.roomName = roomName;
    this.connection.emit('create', roomName, adminPwd, roomPwd, cb);
};
...
Peer.prototype.sendFile = function (commentJSON, msgType, optFile) {
    if (!optFile) {
        optFile = new Blob([""], {type : 'text/html'});
    }
